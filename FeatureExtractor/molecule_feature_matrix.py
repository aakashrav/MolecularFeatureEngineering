...
def _molecular_model_creation(active_fragments,inactive_fragments,features_map, \
    ...
    molecular_clusters.find_clusters(parameter_dictionary, ALG_TYPE, CLUSTER_FILENAME = os.path.join(config.DATA_DIRECTORY,"detected_clusters"),
                ...
                # for PURITY_THRESHOLD in [0.2]: #DRD1
                    ...
                    # for scoring_method in [2]: # DRD1
                        for DIVERSITY_CHECK in [True, False]:
                            ...
                            f_handle.write(DIVERSITY_CHECK)
                            f_handle.write(" ")
